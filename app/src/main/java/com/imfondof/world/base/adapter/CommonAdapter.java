...
//		}
    ...
    // 短按回调
    public abstract void onClickCallback(View v, int position, BaseViewHolder viewHolder);

    // 长按回调
    public abstract boolean onLonClickCallback(View v, int position, BaseViewHolder viewHolder);
}