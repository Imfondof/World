...
/**
 * zhaishuo on 2019/12/18 10:30
 * description:
 */
public class RankTypeFragment extends BaseFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootview = inflater.inflate(R.layout.fragment_rank_type, container, false);
        return rootview;
    }
    ...
    protected void initView(View view) {
        ...
        btn_addTerm = rootview.findViewById(R.id.id_type_add);
        edit_Term =rootview.findViewById(R.id.id_current_type);
        term_list = rootview.findViewById(R.id.type_list);
        text_currentTerm =  rootview.findViewById(R.id.text_currentType);
    }
    ...
    protected void initEvents() {
        ...
        text_currentTerm.setText("当前类型:" + type);
        pref = getActivity().getSharedPreferences("data", Context.MODE_PRIVATE);

        List<Rank> courses = new ArrayList<>();
        ...
        term_list.setAdapter(myAdapter = new CommonAdapter<Rank>(courses, context, R.layout.item_rank_type_list) {
            @Override
            ...
            public void setData(BaseViewHolder holder, Rank item) {
                holder.setText(R.id.tv_rank_type_list_item, item.getType() + "");
            }
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                convertView = LayoutInflater.from(context).inflate(R.layout.item_rank_type_list, parent, false);
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View convertView) {
            if (convertView != null) {
                ...
                tv = convertView.findViewById(R.id.tv_rank_type_list_item);
            }
        }
    }
